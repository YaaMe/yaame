...
local m_mod1 = {"ctrl", "cmd"}
local m_mod2 = {"ctrl", "alt", "cmd"}
-- 应用列表映射
local APPNAMES = {
    IM = "QQ",
    Mail = "Foxmail",
...
---
--  移动到屏幕
hs.hotkey.bind(m_mod2, "[", hs.grid.pushWindowNextScreen)
hs.hotkey.bind(m_mod2, "]", hs.grid.pushWindowPrevScreen)
---
--  修改窗口大小
hs.fnutils.each({
    {key = "h", w = -20, h = 0},
...
---
--  移动鼠标到下个屏幕
hs.hotkey.bind(m_mod2, "p", function()
...
---
--  填充屏幕
hs.hotkey.bind(m_mod2, "up", function()
    local win = hs.window.focusedWindow()
    local f = win:frame()
...
---
-- 缩小0.618，上下三分之一，左右居中
hs.hotkey.bind(m_mod2, "down", function()
    local win = hs.window.focusedWindow()
    local f = win:frame()
    local screen = win:screen()
    local max = screen:frame()

    f.x = max.x + max.w * 0.191
    f.y = max.y + max.h * 0.127
    f.w = max.w * 0.618
    f.h = max.h * 0.745
    win:setFrame(f)
end)
---
--  填充左屏幕
hs.hotkey.bind(m_mod2, "left", function()
    local win = hs.window.focusedWindow()
    local f = win:frame()
    local screen = win:screen()
    local max = screen:frame()
...
---
--  填充右屏幕
hs.hotkey.bind(m_mod2, "right", function()
    local win = hs.window.focusedWindow()
    local f = win:frame()
    local screen = win:screen()
    local max = screen:frame()
